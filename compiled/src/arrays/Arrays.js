...
Arrays.UnboxArray = UnboxArray;
Arrays.Includes = DoesArrayInclude;
Arrays.PushIfNotIncludes = PushIfNotIncludes;
Arrays.GetFirst = GetFirstItem;
Arrays.GetLast = GetLastItem;
Arrays.MaybeGetLast = MaybeGetLastItem;
Arrays.RemoveAnyFromEnd = RemoveAnyFromEndOfArray;
Arrays.GetRandom = GetRandomItem;
Arrays.PushManyIfNotIncludes = PushManyIfNotIncludes;
Arrays.MakeUnique = MakeUniqueArray;
Arrays.GetExclusion = GetArrayExclusion;
Arrays.GetIntersection = GetArrayIntersection;
Arrays.Intersects = DoArraysIntersect;
Arrays.GetItem = GetItemByIndex;
Arrays.ExpectIndexIsInRange = ExpectIndexIsInRange;
Arrays.ContainsDuplicates = DoesArrayContainDuplicates;
Arrays.GetSum = GetArraySum;
Arrays.GetAverage = GetArrayAverage;
Arrays.GetMax = GetArrayMax;
Arrays.GetMin = GetArrayMin;
Arrays.GetRelativeItem = GetRelativeItem;
Arrays.GetNextItemInCycle = GetNextItemInCycle;
Arrays.GetPreviousItemInCycle = GetPreviousItemInCycle;
Arrays.GetIndex = GetIndexByItem;
Arrays.ToggleInclusion = ToggleInclusion;
