...
function SplitStringByRepeatingDelimiters({ string, delimiters, parseDirection, }) {
    ...
    if (parseRightToLeft) {
        ...
        delimiters = delimiters.map(a => Strings.Reverse(a)).reverse();
    }
    let result = [];
    ...
    if (parseRightToLeft) {
        /** Reverse the result */
        result = result.map(a => Strings.Reverse(a)).reverse();
    }
    return result;
}
...
function MakeRandom(length, charset) {
    ...
    while (result.length < length) {
        result += Arrays_1.Arrays.GetRandom(charsetArray);
    }
    return result;
}
...
Strings.GetSubstringCount = GetSubstringCount;
Strings.MultiReplace = MultiReplace;
Strings.GetBetween = GetBetween;
Strings.MaybeGetBetween = MaybeGetBetween;
Strings.GetAnyBetween = GetAnyBetween;
Strings.GetRightOfSubstring = GetRightOfSubstring;
Strings.SetBetween = SetBetween;
Strings.SplitStringByRepeatingDelimiters = SplitStringByRepeatingDelimiters;
Strings.Reverse = Reverse;
Strings.RemoveAnyFromEnd = RemoveAnyFromEnd;
Strings.RemoveExactlyOnceFromEnd = RemoveExactlyOnceFromEnd;
Strings.RemoveAnyFromStart = RemoveAnyFromStart;
Strings.RemoveExactlyOnceFromStart = RemoveExactlyOnceFromStart;
Strings.RemoveAnyFromEnds = RemoveAnyFromEnds;
Strings.MultiRemoveAnyFromStart = MultiRemoveAnyFromStart;
Strings.HasIntersection = HasIntersection;
Strings.IsLowerCase = IsLowerCase;
Strings.RemoveWord = RemoveWord;
Strings.RemoveCharactersFromEnd = RemoveCharactersFromEnd;
Strings.RemoveCharactersFromEnds = RemoveCharactersFromEnds;
Strings.MakeRandom = MakeRandom;
Strings.CanBeParsedAsFloat = CanBeParsedAsFloat;
Strings.RemoveWhitespaceFromEnds = RemoveWhitespaceFromEnds;
Strings.SplitStringByMany = SplitStringByMany;
Strings.SplitStringOnce = SplitStringOnce;
Strings.RemoveSubstring = RemoveSubstring;
Strings.ReplaceSubstring = ReplaceSubstring;
Strings.MaybeReplaceEnding = MaybeReplaceEnding;
Strings.ReplaceFirstSubstring = ReplaceFirstSubstring;
Strings.ReplaceSubstringExactlyOnce = ReplaceSubstringExactlyOnce;
Strings.ReplaceSubstrings = ReplaceSubstrings;
Strings.RemoveCharacters = RemoveCharacters;
Strings.ReplaceCharacters = ReplaceCharacters;
Strings.ReplaceCharactersOutsideCharset = ReplaceCharactersOutsideCharset;
Strings.JoinArrayByRepeatingDelimiters = JoinArrayByRepeatingDelimiters;
Strings.IsInCharset = IsInCharset;
Strings.GetIndicesOf = GetIndicesOf;
Strings.GetIndicesOfMulti = GetIndicesOfMulti;
Strings.GetIndexOfMulti = GetIndexOfMulti;
Strings.PadLeft = PadLeft;
Strings.IsAlphabetic = IsAlphabetic;
Strings.IsAlphanumeric = IsAlphanumeric;
Strings.IsNumeric = IsNumeric;
Strings.IsLowercaseAlphabetic = IsLowercaseAlphabetic;
Strings.IsUppercaseAlphabetic = IsUppercaseAlphabetic;
