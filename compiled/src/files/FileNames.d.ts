...
export declare function MaybeGetFileNameExtension(fileName: FileName): string | undefined;
...
export declare function MaybeGetFormatFromFileName(fileName: FileName): string | undefined;
